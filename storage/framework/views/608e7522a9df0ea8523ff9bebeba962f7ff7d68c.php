...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a href="<?php echo e(url('/')); ?>" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">ANE</span>
    </a>
...
<?php /**PATH C:\wamp64\www\laravel-init\resources\views/layouts/sections/menu/verticalMenu.blade.php ENDPATH**/ ?>