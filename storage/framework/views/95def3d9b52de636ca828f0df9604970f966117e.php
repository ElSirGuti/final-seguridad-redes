  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          <h3>Bienvenido a nuestro proyecto 🚀</h3>
          <p>
            Empecemos con tus datos para que puedas acceder.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <!-- Register Card -->
        <h4 class="mb-2">La aventura empieza aqui 🚀</h4>
        <p class="mb-4">Registrate vamos!</p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/blankLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel-init\resources\views/auth/register.blade.php ENDPATH**/ ?>